...
namespace Mod_Hub_Base
{
	...
	namespace NETWORK
	{
		...
		static void NETWORK_BAIL(int p0, int p1, int p2) { invoke<int>(0x95914459A87EBA28, p0, p1, p2); } // 0x95914459A87EBA28 0x87D79A04 b323
		...
		static void SET_REMOTE_PLAYER_AS_GHOST(Player player, BOOL p1) { invoke<int>(0xA7C511FA1C5BDA38, player, p1); } // 0xA7C511FA1C5BDA38  b463
